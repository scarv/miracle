...
#
# Generated by Vivado on Tue May 14 10:53:58 BST 2019
...
proc cr_bd_system_top { parentCell } {
  ...
  # Create instance: BRAM_CTRL_bram, and set properties
  set BRAM_CTRL_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 BRAM_CTRL_bram ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net AXI_IC_M00_AXI [get_bd_intf_pins AXI_IC/M00_AXI] [get_bd_intf_pins BRAM_CTRL/S_AXI]
  connect_bd_intf_net -intf_net AXI_IC_M01_AXI [get_bd_intf_pins AXI_IC/M01_AXI] [get_bd_intf_pins GPIO/S_AXI]
  connect_bd_intf_net -intf_net AXI_IC_M02_AXI [get_bd_intf_pins AXI_IC/M02_AXI] [get_bd_intf_pins UART/S_AXI]
  connect_bd_intf_net -intf_net BRAM_CTRL_BRAM_PORTA [get_bd_intf_pins BRAM_CTRL/BRAM_PORTA] [get_bd_intf_pins BRAM_CTRL_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net BRAM_CTRL_BRAM_PORTB [get_bd_intf_pins BRAM_CTRL/BRAM_PORTB] [get_bd_intf_pins BRAM_CTRL_bram/BRAM_PORTB]
  ...
  create_bd_addr_seg -range 0x00008000 -offset 0x00000000 [get_bd_addr_spaces CPU_MB3/Data] [get_bd_addr_segs BRAM_CTRL/S_AXI/Mem0] SEG_BRAM_CTRL_Mem0
  create_bd_addr_seg -range 0x00008000 -offset 0x00000000 [get_bd_addr_spaces CPU_MB3/Instruction] [get_bd_addr_segs BRAM_CTRL/S_AXI/Mem0] SEG_BRAM_CTRL_Mem0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces CPU_MB3/Instruction] [get_bd_addr_segs GPIO/S_AXI/Reg] SEG_GPIO_Reg
