...
#
# vivado_sakurax_mb3.tcl: Tcl script for re-creating project 'sakurax-mb3'
#
# Generated by Vivado on Tue May 21 08:36:02 BST 2019
...
#
# 1. This project restoration tcl script (vivado_sakurax_mb3.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/ben/scarv/repos/pipeline-leakage/build/vivado/sakurax-mb3/sakurax-mb3.srcs/sources_1/bd/system_top/hdl/system_top_wrapper.v"
#    "/home/ben/scarv/repos/pipeline-leakage/build/vivado/sakurax-mb3/sakurax-mb3.srcs/constrs_1/new/sakurax_mb3.xdc"
#
...
set _xil_proj_name_ "sakurax-mb3"
...
set script_file "vivado_sakurax_mb3.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../build/vivado/sakurax-mb3"]"
...
set file "[file normalize "$origin_dir/flow/sakurax_mb3.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "sakurax_mb3.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *sakurax_mb3.xdc]" -objects $obj
...
proc cr_bd_system_top { parentCell } {
  ...
  # Create instance: CPU_MB3, and set properties
  set CPU_MB3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:11.0 CPU_MB3 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net CPU_MB3_DLMB [get_bd_intf_pins CPU_MB3/DLMB] [get_bd_intf_pins DATA_LMB/SLMB]
  connect_bd_intf_net -intf_net CPU_MB3_ILMB [get_bd_intf_pins CPU_MB3/ILMB] [get_bd_intf_pins INST_LMB/SLMB]
  connect_bd_intf_net -intf_net CPU_MB3_M_AXI_DP [get_bd_intf_pins AXI_IC/S00_AXI] [get_bd_intf_pins CPU_MB3/M_AXI_DP]
  connect_bd_intf_net -intf_net CPU_MB3_M_AXI_IP [get_bd_intf_pins AXI_IC/S01_AXI] [get_bd_intf_pins CPU_MB3/M_AXI_IP]
  ...
  connect_bd_net -net RESET_mb_reset [get_bd_pins CPU_MB3/Reset] [get_bd_pins RESET/mb_reset]
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces CPU_MB3/Data] [get_bd_addr_segs BRAM_0/S_AXI/Mem0] SEG_BRAM_0_Mem0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces CPU_MB3/Instruction] [get_bd_addr_segs GPIO/S_AXI/Reg] SEG_GPIO_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40600000 [get_bd_addr_spaces CPU_MB3/Instruction] [get_bd_addr_segs UART/S_AXI/Reg] SEG_UART_Reg
  exclude_bd_addr_seg [get_bd_addr_segs CPU_MB3/Instruction/SEG_GPIO_Reg]
  exclude_bd_addr_seg [get_bd_addr_segs CPU_MB3/Instruction/SEG_UART_Reg]
