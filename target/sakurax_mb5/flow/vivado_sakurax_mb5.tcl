...
#
#    "/home/ben/scarv/repos/pipeline-leakage/build/vivado/sakurax-mb5/sakurax-mb5.srcs/sources_1/imports/sakurax_mb3/hdl/system_top_wrapper.v"
#    "/home/ben/scarv/repos/pipeline-leakage/build/vivado/sakurax-mb5/sakurax-mb5.srcs/constrs_1/imports/sakurax_mb3/flow/sakurax_mb5.xdc"
#
...
set _xil_proj_name_ "sakurax-mb5"
...
set script_file "vivado_sakurax_mb5.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../build/vivado/sakurax-mb5"]"
...
set files [list \
 [file normalize "${origin_dir}/hdl/system_top_wrapper.v"]\
]
...
set file "[file normalize ${origin_dir}/flow/sakurax_mb5.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "sakurax_mb5.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *sakurax_mb5.xdc]" -objects $obj
...
proc cr_bd_system_top { parentCell } {
  ...
  set BRAM_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 BRAM_0 ]
  ...
  set BRAM_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 BRAM_1 ]
  ...
  # Create instance: CPU_MB5, and set properties
  set CPU_MB5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:11.0 CPU_MB5 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net CPU_MB3_DLMB [get_bd_intf_pins CPU_MB5/DLMB] [get_bd_intf_pins DATA_LMB/SLMB]
  connect_bd_intf_net -intf_net CPU_MB3_ILMB [get_bd_intf_pins CPU_MB5/ILMB] [get_bd_intf_pins INST_LMB/SLMB]
  connect_bd_intf_net -intf_net CPU_MB3_M_AXI_DP [get_bd_intf_pins AXI_IC/S00_AXI] [get_bd_intf_pins CPU_MB5/M_AXI_DP]
  connect_bd_intf_net -intf_net CPU_MB3_M_AXI_IP [get_bd_intf_pins AXI_IC/S01_AXI] [get_bd_intf_pins CPU_MB5/M_AXI_IP]
  ...
  connect_bd_net -net RESET_mb_reset [get_bd_pins CPU_MB5/Reset] [get_bd_pins RESET/mb_reset]
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces CPU_MB5/Data] [get_bd_addr_segs BRAM_0/S_AXI/Mem0] SEG_BRAM_0_Mem0
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces CPU_MB5/Instruction] [get_bd_addr_segs BRAM_0/S_AXI/Mem0] SEG_BRAM_0_Mem0
  create_bd_addr_seg -range 0x00004000 -offset 0x00004000 [get_bd_addr_spaces CPU_MB5/Data] [get_bd_addr_segs BRAM_1/S_AXI/Mem0] SEG_BRAM_1_Mem0
  create_bd_addr_seg -range 0x00004000 -offset 0x00004000 [get_bd_addr_spaces CPU_MB5/Instruction] [get_bd_addr_segs BRAM_1/S_AXI/Mem0] SEG_BRAM_1_Mem0
  create_bd_addr_seg -range 0x00004000 -offset 0x10000000 [get_bd_addr_spaces CPU_MB5/Data] [get_bd_addr_segs DATA_LMB/SLMB/Mem] SEG_DATA_LMB_Mem
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces CPU_MB5/Data] [get_bd_addr_segs GPIO/S_AXI/Reg] SEG_GPIO_Reg
  create_bd_addr_seg -range 0x00004000 -offset 0x10000000 [get_bd_addr_spaces CPU_MB5/Instruction] [get_bd_addr_segs INST_LMB/SLMB/Mem] SEG_INST_LMB_Mem
  create_bd_addr_seg -range 0x00001000 -offset 0x40600000 [get_bd_addr_spaces CPU_MB5/Data] [get_bd_addr_segs UART/S_AXI/Reg] SEG_UART_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces CPU_MB5/Instruction] [get_bd_addr_segs GPIO/S_AXI/Reg] SEG_GPIO_Reg
  exclude_bd_addr_seg [get_bd_addr_segs CPU_MB5/Instruction/SEG_GPIO_Reg]

  create_bd_addr_seg -range 0x00001000 -offset 0x40600000 [get_bd_addr_spaces CPU_MB5/Instruction] [get_bd_addr_segs UART/S_AXI/Reg] SEG_UART_Reg
  exclude_bd_addr_seg [get_bd_addr_segs CPU_MB5/Instruction/SEG_UART_Reg]
