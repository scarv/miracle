...
set file "[file normalize ${origin_dir}/sakurax_mb5.xdc]"
...
proc cr_bd_system_top { parentCell } {
  ...
  set CPU_MB5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:10.0 CPU_MB5 ]
  set_property -dict [ list \
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0x10000000 [get_bd_addr_spaces CPU_MB5/Data] [get_bd_addr_segs DATA_LMB/SLMB/Mem] SEG_DATA_LMB_Mem
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0x10000000 [get_bd_addr_spaces CPU_MB5/Instruction] [get_bd_addr_segs INST_LMB/SLMB/Mem] SEG_INST_LMB_Mem
