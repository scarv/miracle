...
#
# vivado_sakurax_picorv32_new.tcl: Tcl script for re-creating project 'sakurax-picorv32'
#
# Generated by Vivado on Wed Jun 05 09:40:59 BST 2019
...
#
# 1. This project restoration tcl script (vivado_sakurax_picorv32_new.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/ben/scarv/repos/pipeline-leakage/build/vivado/sakurax-picorv32/sakurax-picorv32.srcs/sources_1/imports/sakurax_picorv32/hdl/system_top_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/ben/scarv/repos/pipeline-leakage/target/sakurax_picorv32/hdl/picorv32.v"
#    "/home/ben/scarv/repos/pipeline-leakage/target/sakurax_picorv32/flow/sakurax_picorv32.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "sakurax-picorv32"
...
set script_file "vivado_sakurax_picorv32.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../build/vivado/sakurax-picorv32"]"
...
set file "$origin_dir/hdl/picorv32.v"
...
set file "[file normalize "$origin_dir/flow/sakurax_picorv32.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/flow/sakurax_picorv32.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[get_files *sakurax_picorv32.xdc]" -objects $obj
...
if { [get_files picorv32.v] == "" } {
  import_files -quiet -fileset sources_1 $origin_dir/picorv32.v
}
...
# picorv32_axi
  ...
  set block_cell_name PICORV32
  if { [catch {set PICORV32 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
 ...
 ] [get_bd_intf_pins /PICORV32/mem_axi]
  ...
  connect_bd_intf_net -intf_net picorv32_axi_0_mem_axi [get_bd_intf_pins AXI_IC/S00_AXI] [get_bd_intf_pins PICORV32/mem_axi]

  # Create port connections
  connect_bd_net -net CLK_clk_out1 [get_bd_pins AXI_IC/ACLK] [get_bd_pins AXI_IC/M00_ACLK] [get_bd_pins AXI_IC/M01_ACLK] [get_bd_pins AXI_IC/M02_ACLK] [get_bd_pins AXI_IC/M03_ACLK] [get_bd_pins AXI_IC/S00_ACLK] [get_bd_pins BRAM_0/s_axi_aclk] [get_bd_pins BRAM_1/s_axi_aclk] [get_bd_pins CLK/clk_out1] [get_bd_pins GPIO/s_axi_aclk] [get_bd_pins PICORV32/clk] [get_bd_pins RESET/slowest_sync_clk] [get_bd_pins UART/s_axi_aclk]
  ...
  connect_bd_net -net RESET_peripheral_aresetn [get_bd_pins AXI_IC/M00_ARESETN] [get_bd_pins AXI_IC/M01_ARESETN] [get_bd_pins AXI_IC/M02_ARESETN] [get_bd_pins AXI_IC/M03_ARESETN] [get_bd_pins AXI_IC/S00_ARESETN] [get_bd_pins BRAM_0/s_axi_aresetn] [get_bd_pins BRAM_1/s_axi_aresetn] [get_bd_pins GPIO/s_axi_aresetn] [get_bd_pins PICORV32/resetn] [get_bd_pins RESET/peripheral_aresetn] [get_bd_pins UART/s_axi_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins PICORV32/pcpi_ready] [get_bd_pins PICORV32/pcpi_wait] [get_bd_pins PICORV32/pcpi_wr] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins PICORV32/irq] [get_bd_pins PICORV32/pcpi_rd] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces PICORV32/mem_axi] [get_bd_addr_segs BRAM_0/S_AXI/Mem0] SEG_BRAM_0_Mem0
  create_bd_addr_seg -range 0x00004000 -offset 0x10000000 [get_bd_addr_spaces PICORV32/mem_axi] [get_bd_addr_segs BRAM_1/S_AXI/Mem0] SEG_BRAM_1_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces PICORV32/mem_axi] [get_bd_addr_segs GPIO/S_AXI/Reg] SEG_GPIO_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40600000 [get_bd_addr_spaces PICORV32/mem_axi] [get_bd_addr_segs UART/S_AXI/Reg] SEG_UART_Reg
