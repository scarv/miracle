...
class CaptureInterface(object):
    ...
    def dbInsertTTestTraceSet(self, 
        ...
        ts_fixed.targetFreq     = ttest.target_clk_info.sys_clk_rate
        ts_rand.targetFreq      = ttest.target_clk_info.sys_clk_rate
        ...
        ttraceset   = ldb.records.TTraceSet(
            ...
            targetFreq      = ttest.target_clk_info.sys_clk_rate
        )
