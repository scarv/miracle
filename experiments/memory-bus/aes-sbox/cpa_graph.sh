...
run_cpa $WORK/scale_lpc1114fn28/aes-sbox-10k/ttest-random.trs
run_cpa $WORK/scale_lpc1313fbd48/aes-sbox-10k/ttest-random.trs
run_cpa $WORK/scale_lpc812m101/aes-sbox-10k/ttest-random.trs
run_cpa $WORK/sakurax_mb3/aes-sbox-100k/ttest-random.trs
run_cpa $WORK/sakurax_mb5/aes-sbox-100k/ttest-random.trs
run_cpa $WORK/sakurax_mb8/aes-sbox-100k/ttest-random.trs
run_cpa $WORK/sakurax_picorv32/aes-sbox-100k/ttest-random.trs
