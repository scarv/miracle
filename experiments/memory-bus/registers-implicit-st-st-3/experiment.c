...
/*!
@defgroup experiments-memory-registers-implicit-st-st-3-code Experiment Code
@{
@ingroup experiments-memory-registers-implicit-st-st-3
*/
...
void experiment_setup_scass(
    ...
    cfg -> experiment_name       = "memory-bus/registers-implicit-st-st-3";
