...
# Usage:
#
#   $> ./experiments/memory-bus/bus-width-hw/scale-ttest-all.sh <target> <serial port>
#

TT_NAME=bus-width-hw-10k
...
${UAS_ROOT}/experiments/memory-bus/bus-width-hw/ttest_graph.sh $1 ${TT_NAME}
