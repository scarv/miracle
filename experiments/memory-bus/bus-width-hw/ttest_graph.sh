...
TARGET=$1
TTEST_NAME=$2
EXPERIMENT=memory-bus/bus-width-hw
...
$UAS_ROOT/external/fw-acquisition/ttest_multi_analyse.py \
    ...
    -t lb7 $UAS_ROOT/build/${EXPERIMENT}/$TARGET/${TTEST_NAME}/8/ttest-fixed.trs $UAS_ROOT/build/${EXPERIMENT}/$TARGET/${TTEST_NAME}/8/ttest-random.trs 
