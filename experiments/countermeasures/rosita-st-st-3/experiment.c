...
/*!
@defgroup experiments-countermeasures-rosita-st-st-code Experiment Code
@{
@ingroup  experiments-countermeasures-rosita-st-st
*/
...
uint8_t experiment_run(
    ...
    result       = 0;
    uint32_t d1  = (fixed ? di1_fixed: di1_rand) ^ wrd_mask;
    uint32_t d2  = (fixed ? di2_fixed: di2_rand) ^ wrd_mask;
...
void experiment_setup_scass(
    ...
    cfg -> experiment_name       = "countermeasures/rosita-st-st-3";
