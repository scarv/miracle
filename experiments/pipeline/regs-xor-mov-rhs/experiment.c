...
/*!
@defgroup experiments-pipeline-reg-xor-mov-rhs-code Experiment Code
@{
@ingroup  experiments-pipeline-reg-xor-mov-rhs
*/
...
void experiment_setup_scass(
    ...
    cfg -> experiment_name       = "pipeline/regs-xor-mov-rhs";
