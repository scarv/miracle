...
/*!
@defgroup experiments-pipeline-reg-xor-mov-lhs-code Experiment Code
@{
@ingroup  experiments-pipeline-reg-xor-mov-lhs
*/
...
void experiment_setup_scass(
    ...
    cfg -> experiment_name       = "pipeline/regs-xor-mov-lhs";
