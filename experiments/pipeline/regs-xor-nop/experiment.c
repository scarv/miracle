...
/*!
@defgroup experiments-pipeline-reg-xor-nop-code Experiment Code
@{
@ingroup  experiments-pipeline-reg-xor-nop
*/
...
uint8_t experiment_run(
    ...
    uint8_t d3 = (fixed ? di3_fixed: di3_rand);
    uint8_t d4 = (fixed ? di4_fixed: di4_rand);
